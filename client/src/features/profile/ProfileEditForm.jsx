...
const ProfileEditForm = ({ profile, onSave }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-lg mx-auto bg-white rounded-xl shadow-lg p-8 mt-6 space-y-6 animate-fade-in">
      <div>
        ...
        <textarea
          ...
          rows={4}
          className="w-full border rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all"
        />
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full border rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all ${errors.website ? 'border-red-500' : ''}`}
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full border rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all ${errors.twitter ? 'border-red-500' : ''}`}
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full border rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all ${errors.instagram ? 'border-red-500' : ''}`}
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full border rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all ${errors.facebook ? 'border-red-500' : ''}`}
          />
          {errors.facebook && <p className="text-red-500 text-xs mt-1">{errors.facebook}</p>}
        </div>
      </div>
      <div className="pt-2 flex justify-end">
        <button type="submit" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-2 rounded-full font-semibold shadow transition">
          Save Changes
        </button>
      </div>
    </form>
